...
/**
 * 项目名称:com.steven.saar.common.plugin.service
 * 类名称:BaseMovableService
 * 描述:
 * 创建人:steven
 * 创建时间:2018-05-20 00:32
 */
public abstract class BaseMovableService<T extends BaseEntity & Movable, ID extends Serializable> extends BaseServiceImpl<T, ID> {
